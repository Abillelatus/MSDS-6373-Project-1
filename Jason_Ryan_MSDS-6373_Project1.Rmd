...
col_names <- names(life_exp_v004)
col_names_index <- 1

for (col in life_exp_v004) {
  plot(life_exp_v004$Life.expectancy, col, 
...
# Version 005
life_exp_v005 <- subset(life_exp_v004, select=-thinness.5.9.years) # Removes Thiness 5-9 col

# Log transform Percentage.expenditure, GDP,
life_exp_v005$percentage.expenditure <- log(life_exp_v005$percentage.expenditure)
life_exp_v005$GDP <- log(life_exp_v005$GDP)

# Check the charts after transformation
# It's only three, I don't need to loop through this 
plot(life_exp_v005$Life.expectancy, life_exp_v005$percentage.expenditure,
     main="percentage.expenditure", xlab="Life Expectancy")
plot(life_exp_v005$Life.expectancy, life_exp_v005$GDP,
