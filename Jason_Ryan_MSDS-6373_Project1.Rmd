...
# Remove life expectancy for the matrix for glmnet
life_exp_train_v06.1 <- subset(life_exp_train_v06, select=c(-Life.expectancy))

# Matrix for glmnet
lasso_y <- life_exp_train_v06$Life.expectancy
